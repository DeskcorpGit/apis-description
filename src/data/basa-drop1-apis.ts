    ...
    endpoints: [
      {
        ...
        parameters: [
          ...
          { name: "assuntoId", in: "query", required: true, type: "string", description: "Identificador único do documento que virá a ser retornado" },
        ],
        responses: [
          { statusCode: "200", description: "assuntoId informado corretamente", example: '{\n  "fileName": "Modelo_02_01_01_01_03_v1.pdf",\n  "sucesso": true,\n  "assuntoId": 20\n}' },
          { statusCode: "400", description: "assuntoId informado inexistente", example: '{ "erro": "Nenhuma versão encontrada para o código: " }' },
          { statusCode: "401", description: "apikey mal informada", example: '{ "erro": "API Key inválida ou não fornecida." }' },
        ],
      },
    ],
  },
    ...
    endpoints: [
      {
        ...
        parameters: [
          { name: "page_size", in: "query", required: true, type: "string", description: "Referente aos itens retornados" },
        ],
        responses: [
          { statusCode: "200", description: "CEP informado existe e possui formato válido", example: '{\n  "dados": [{\n    "estado": "Pará",\n    "bairro": "Cremação",\n    "localidade": "Belém",\n    "cep": "66045-205",\n    "uf": "PA"\n  }]\n}' },
          { statusCode: "400", description: "CEP informado é inválido ou inexistente", example: '{ "erro": "Erro ao consultar dados" }' },
        ],
      },
    ],
  },
    ...
    endpoints: [
      {
        ...
        responses: [
          { statusCode: "200", description: "Endpoint formatado corretamente com seus respectivos parâmetros", example: '{\n  "header": { "total_size": 2694, "status": "success" },\n  "body": [{ "jobTitleName": "Oficial general da aeronáutica", "jobTitleId": "010105" }]\n}' },
          { statusCode: "400", description: "Credenciais informadas de maneira inválida", example: '{ "error": "invalid_client", "message": "Client authentication failed" }' },
        ],
      },
    ],
  },
    ...
    endpoints: [
      {
        ...
        parameters: [],
        responses: [
          { statusCode: "200", description: "Credenciais informadas corretamente", example: '{\n  "access_token": "eyJhbGciOiJSUzI1NiIs...",\n  "expires_in": 3600,\n  "token_type": "Bearer"\n}' },
          { statusCode: "422", description: "CPF informado era inválido", example: '{ "error": "create person entity: invalid CPF: check digit mismatch" }' },
          { statusCode: "500", description: "client_id informado é inválido", example: '{ "code": 500, "message": "The server encountered an internal error..." }' },
          { statusCode: "401", description: "client_secret informado é inválido", example: '{ "error": "invalid_client" }' },
        ],
      },
    ],
  },
    ...
    endpoints: [
      {
        ...
        parameters: [],
        responses: [
          { statusCode: "200", description: "CPF e senha inseridos corretamente", example: '{ "success": true }' },
          { statusCode: "401", description: "Token informado é inválido", example: '{ "error": "invalid_token", "error_description": "The access token provided is expired, revoked, malformed, or invalid for other reasons." }' },
        ],
      },
    ],
  },
    ...
    endpoints: [
      {
        ...
        parameters: [],
        responses: [
          { statusCode: "200", description: "CPF válido junto com os demais dados", example: '{\n  "person_entity_id": "45616b6f-1869-436e-889a-3bb7e19dc6be",\n  "cpf": "394.499.710-72",\n  "created_at": "2026-05-15T21:41:18.134794395Z"\n}' },
          { statusCode: "422", description: "CPF informado era inválido", example: '{ "error": "create person entity: invalid CPF: check digit mismatch" }' },
          { statusCode: "409", description: "CPF informado já existia", example: '{ "error": "create person entity: invalid CPF: check digit mismatch" }' },
        ],
      },
    ],
  },
    ...
    endpoints: [
      {
        ...
        parameters: [],
        responses: [
          { statusCode: "200", description: "Credenciais do usuário informadas corretamente (CPF e senha já cadastrados)", example: '{\n  "access_token": "eyJhbGciOiJSUzI1NiIs...",\n  "expires_in": 3600,\n  "scope": "profile",\n  "token_type": "Bearer"\n}' },
          { statusCode: "400", description: "CPF e senha ainda não cadastrados no sistema", example: '{ "error": "invalid_request", "error_description": "Invalid username or password in request." }' },
          { statusCode: "500", description: "Inserção de clientId inválido", example: '{ "code": 500, "message": "The server encountered an internal error..." }' },
          { statusCode: "401", description: "Inserção de clientSecret inválido", example: '{ "error": "invalid_client" }' },
        ],
      },
    ],
  },
    ...
    endpoints: [
      {
        ...
        parameters: [],
        responses: [
          { statusCode: "200", description: "Token informado corretamente", example: '{\n  "person_entity_id": "b5d26843-60e5-4feb-90e5-4a04d22bc255",\n  "accepted_terms": true,\n  "accepted_terms_at": "2026-05-15T20:13:22.827453603Z"\n}' },
          { statusCode: "401", description: "Token utilizado já expirou ou é inválido", example: '{ "error": "invalid token: token expired" }' },
        ],
      },
    ],
  },
    ...
    endpoints: [
      {
        ...
        parameters: [],
        responses: [
          { statusCode: "200", description: "CPF válido (existe, não existe ou com reset)", example: '{\n  "exists": true,\n  "cpf_formatted": "893.584.790-94",\n  "person_entity_id": "b5d26843-...",\n  "type": "PF",\n  "has_resets": false\n}' },
          { statusCode: "422", description: "CPF possui formato inválido", example: '{ "error": "check cpf: invalid CPF: must have 11 digits" }' },
        ],
      },
    ],
  },
    ...
    endpoints: [
      {
        ...
        parameters: [],
        responses: [
          { statusCode: "200", description: "Dados atualizados com sucesso e token válido", example: '{\n  "person_entity_id": "b5d26843-60e5-4feb-90e5-4a04d22bc255",\n  "updated_at": "2026-05-15T20:46:57.376793181Z"\n}' },
          { statusCode: "401", description: "Token informado é inválido ou expirado", example: '{ "error": "invalid token: token expired" }' },
        ],
      },
    ],
  },
    ...
    endpoints: [
      {
        ...
        parameters: [],
        responses: [
          { statusCode: "200", description: "Dados submetidos com sucesso e token válido", example: '{\n  "person_entity_id": "b5d26843-...",\n  "onboarding_status": "PENDING_REVIEW",\n  "updated_at": "2026-05-15T21:04:37.887915374Z"\n}' },
          { statusCode: "401", description: "Token informado já expirou ou é inválido", example: '{ "error": "invalid token: token expired" }' },
        ],
      },
    ],
  },
    ...
    endpoints: [
      {
        ...
        parameters: [],
        responses: [
          { statusCode: "200", description: "Entidade resetada com sucesso e token válido", example: '{ "message": "Usuário resetado com sucesso.", "status": 200 }' },
          { statusCode: "401", description: "Token informado já expirou ou é inválido", example: '{ "error": "invalid token: token expired" }' },
        ],
      },
    ],
    ...
    endpoints: [
      {
        ...
        parameters: [],
        responses: [
          { statusCode: "200", description: "Request body preenchido corretamente", example: '{\n  "token_type": "Bearer",\n  "expires_in": 900,\n  "access_token": "eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1Ni..."\n}' },
          { statusCode: "400", description: "Credenciais informadas de maneira inválida", example: '{ "error": "invalid_client", "message": "Client authentication failed" }' },
        ],
      },
    ],
    ...
    endpoints: [
      {
        ...
        parameters: [],
        responses: [
          { statusCode: "200", description: "transactionId informado é válido", example: '{\n  "transactionId": "a6fc0fd1-...",\n  "status": "COMPLETED_PASS",\n  "results": { "overall": "PASS" }\n}' },
          { statusCode: "404", description: "transactionId inválido ou inexistente", example: '{ "status": "error", "message": "Transaction not found." }' },
        ],
      },
    ],
  },
    ...
    endpoints: [
      {
        ...
        parameters: [],
        responses: [
          { statusCode: "200", description: "Dados informados corretamente (ou 201 Created)", example: '{\n  "header": { "id": "1000000697", "status": "success" },\n  "body": { "customerMnemonic": "R41928105068" }\n}' },
          { statusCode: "400", description: "Mnemônico já existe ou formato incorreto", example: '{ "error": { "type": "BUSINESS", "errorDetails": [{ "fieldName": "customerMnemonic", "code": "E-115490" }] } }' },
        ],
      },
    ],
  },
    ...
    endpoints: [
      {
        ...
        tags: ["Transact", "Customer"],
        parameters: [
          { name: "mnemonic", in: "query", required: true, type: "string", description: "Identificador único do usuário" },
        ],
        responses: [
    ...
    endpoints: [
      {
        ...
        parameters: [],
        responses: [
          { statusCode: "200", description: "coreCustomerId informado corretamente junto com os demais campos", example: '{\n  "header": { "id": "1000000599", "status": "success" },\n  "body": { "declaredAssets": "3000000", "declaredIncome": "10000" }\n}' },
          { statusCode: "400", description: "coreCustomerId inválido, já atualizado ou inexistente", example: '{ "error": { "type": "BUSINESS", "errorDetails": [{ "code": "E-130147" }] } }' },
        ],
      },
    ],
  },
    ...
    endpoints: [
      {
        ...
        parameters: [],
        responses: [
          { statusCode: "200", description: "coreCustomerId informado corretamente", example: '{\n  "header": { "transactionStatus": "Live" },\n  "body": { "accountId": "1000073818" },\n  "httpStatusCode": 200\n}' },
          { statusCode: "400", description: "coreCustomerId inválido ou inexistente", example: '{ "error": { "type": "BUSINESS", "errorDetails": [{ "code": "E-130147" }] } }' },
        ],
      },
    ],
  },
    ...
    endpoints: [
      {
        ...
        parameters: [
          { name: "rateId", in: "query", required: true, type: "string", description: "Identificador da taxa" },
        ],
        responses: [
